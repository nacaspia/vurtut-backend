...
!function (t, e) {
    ...
    var e = function () {
        ...
        h = o('<div class="dropdown-menu" role="list">', function (e, o) {
            var n = t.isArray(o.items) ? o.items.map(function (t) {
                var e = "string" == typeof t ? t : t.value || "", n = o.template ? o.template(t) : t,
        ...
        g = o(['<div class="note-popover popover in">', '  <div class="arrow"/>', '  <div class="popover-content note-children-container"/>', "</div>"].join(""), function (t, e) {
            ...
            button: function (t, e) {
                return o('<button type="button" class="note-btn btn btn-light btn-sm" role="button" tabindex="-1">', function (t, e) {
                    e && e.tooltip && t.attr({title: e.tooltip, "aria-label": e.tooltip}).tooltip({
                        container: e.container,
                        trigger: "hover",
                        placement: "bottom"
                    })
    ...
    var A, R = navigator.userAgent, P = /MSIE|Trident/i.test(R);
    if (P) {
        var L = /MSIE (\d+[.]\d+)/.exec(R);
        L && (A = parseFloat(L[1])), (L = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(R)) && (A = parseFloat(L[1]))
    }
    var H = /Edge\/\d+/.test(R), D = !!window.CodeMirror;
    if (!D && E) if ("function" == typeof __webpack_require__) try {
    ...
    var F = "ontouchstart" in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0,
        B = P || H ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input", z = {
            ...
            isFontInstalled: function (e) {
                var o = "Comic Sans MS" === e ? "Courier New" : "Comic Sans MS", n = t("<div>").css({
                        position: "absolute",
                        left: "-9999px",
                        top: "-9999px",
                        fontSize: "200px"
                    }).text("mmmmmmmmmwwwwwww").appendTo(document.body), i = n.css("fontFamily", o).width(),
    ...
    function wt(t, e) {
        var o = e && e.isSkipPaddingBlankHTML, n = e && e.isNotSplitEdgePoint;
        if (ft(t) && (j(t.node) || n)) {
            if (ht(t)) return t.node;
            if (pt(t)) return t.node.nextSibling
        }
        if (j(t.node)) return t.node.splitText(t.offset);
        var i = t.node.childNodes[t.offset], r = dt(t.node.cloneNode(!1), t.node);
    ...
    var Nt = {
        ...
        listDescendant: function (t, e) {
            var o = [];
            return e = e || C.ok, function n(i) {
                t !== i && e(i) && o.push(i);
                for (var r = 0, s = i.childNodes.length; r < s; r++) n(i.childNodes[r])
            }(t), o
        },
        commonAncestor: function (e, o) {
            for (var n = lt(e), i = o; i; i = i.parentNode) if (t.inArray(i, n) > -1) return i;
            return null
        },
        wrap: function (e, o) {
            var n = e.parentNode, i = t("<" + o + ">")[0];
        ...
        posFromPlaceholder: function (e) {
            var o = t(e), n = o.offset(), i = o.outerHeight(!0);
    ...
    t.summernote = t.summernote || {lang: {}}, t.extend(t.summernote.lang, {
        "en-US": {
            font: {
                bold: "Bold",
                italic: "Italic",
    ...
    var Et = {
        ...
        }, nameFromCode: C.invertObject(Et), code: Et
    };
    ...
    function Pt(t) {
        var e = function (t, o) {
            var n, i;
            if (Nt.isText(t)) {
                var r = Nt.listPrev(t, C.not(Nt.isText)), s = N.last(r).previousSibling;
        ...
        }, o = document.body.createTextRange(), n = e(t.node, t.offset);
    ...
    var Lt = function () {
        ...
        return e.prototype.nativeRange = function () {
            ...
            return e.setEndPoint("EndToEnd", Pt({node: this.ec, offset: this.eo})), e
            ...
            }, o = t(this.getEndPoint(), !1), n = this.isCollapsed() ? o : t(this.getStartPoint(), !0);
            return new e(n.node, n.offset, o.node, o.offset)
        }, e.prototype.nodes = function (t, e) {
            t = t || C.ok;
            var o = e && e.includeAncestor, n = e && e.fullyContains, i = this.getStartPoint(), r = this.getEndPoint(),
                s = [], a = [];
            ...
            var o = Nt.ancestor(this.sc, t), n = Nt.ancestor(this.ec, t);
            ...
            var t = this.sc === this.ec, o = this.getPoints();
            ...
            var o = t("<div></div>").html(e)[0], n = N.from(o.childNodes),
    ...
    var Dt = function () {
        ...
        return e.prototype.jQueryCSS = function (e, o) {
            ...
            var s = Nt.makePredByNodeName(n), a = e.nodes(Nt.isText, {fullyContains: !0}).map(function (t) {
            ...
            if (i) {
                ...
                return a.map(function (e) {
                    var o = Nt.withClosestSiblings(e, s), n = N.head(o), i = N.tail(o);
            ...
            var o = t(Nt.isElement(e.sc) ? e.sc : e.sc.parentNode), n = this.fromNode(o);
            try {
                n = t.extend(n, {
        ...
        return e.prototype.insertOrderedList = function (t) {
            ...
            var o = this, n = Ht.create(e).wrapBodyInlineWithPara(), i = n.nodes(Nt.isPara, {includeAncestor: !0}),
            ...
            var n = this, i = Ht.create(o).wrapBodyInlineWithPara(), r = i.nodes(Nt.isPara, {includeAncestor: !0}),
                s = i.paraBookmark(r), a = N.clusterBy(r, C.peq2("parentNode"));
            ...
            return t.each(e, function (e, i) {
                var r = N.head(i), s = N.last(i), a = o ? Nt.lastAncestor(r, Nt.isList) : r.parentNode,
        ...
        return e.prototype.insertTab = function (t, e) {
            ...
            if (i) {
                ...
                if (Nt.isEmpty(i) && Nt.isPara(i) && Nt.isBlockquote(i.parentNode)) Nt.insertAfter(i, i.parentNode), n = i; else {
        ...
        function c(t, e) {
            var o = l(t.rowIndex, e.cellIndex), n = e.colSpan > 1, r = e.rowSpan > 1,
        ...
        this.getActionList = function () {
            ...
            for (var t = n.rows, e = 0; e < t.length; e++) for (var o = t[e].cells, i = 0; i < o.length; i++) c(t[e], o[i])
        }()
    };
    ...
    var Ot, Ut = function () {
        ...
        return e.prototype.tab = function (t, e) {
            ...
            for (var n = Nt.ancestor(e.commonAncestor(), Nt.isCell), i = t(n).closest("tr"), r = this.recoverAttributes(i), s = t("<tr" + r + "></tr>"), a = new Mt(n, Mt.where.Row, Mt.requestAction.Add, t(i).closest("table")[0]).getActionList(), l = 0; l < a.length; l++) {
                var c = a[l], d = this.recoverAttributes(c.baseCell);
                switch (c.action) {
            ...
            var n = Nt.ancestor(e.commonAncestor(), Nt.isCell), i = t(n).closest("tr");
            t(i).siblings().push(i);
            for (var r = new Mt(n, Mt.where.Column, Mt.requestAction.Add, t(i).closest("table")[0]).getActionList(), s = 0; s < r.length; s++) {
                var a = r[s], l = this.recoverAttributes(a.baseCell);
                switch (a.action) {
                    case Mt.resultAction.AddCell:
            ...
            for (var o = Nt.ancestor(e.commonAncestor(), Nt.isCell), n = t(o).closest("tr"), i = n.children("td, th").index(t(o)), r = n[0].rowIndex, s = new Mt(o, Mt.where.Row, Mt.requestAction.Delete, t(n).closest("table")[0]).getActionList(), a = 0; a < s.length; a++) if (s[a]) {
                var l = s[a].baseCell, c = s[a].virtualTable, d = l.rowSpan && l.rowSpan > 1,
            ...
            for (var o = Nt.ancestor(e.commonAncestor(), Nt.isCell), n = t(o).closest("tr"), i = n.children("td, th").index(t(o)), r = new Mt(o, Mt.where.Column, Mt.requestAction.Delete, t(n).closest("table")[0]).getActionList(), s = 0; s < r.length; s++) if (r[s]) switch (r[s].action) {
                case Mt.resultAction.Ignore:
                    continue;
                case Mt.resultAction.SubtractSpanCount:
                    var a = r[s].baseCell;
        ...
        function e(e) {
            ...
            this.insertParagraph = this.wrapCommand(function () {
                ...
                var n = e.url, i = e.text, r = e.isNewWindow, s = e.range || o.createRange(), a = s.toString() !== i;
        ...
        return e.prototype.initialize = function () {
            ...
            var e = this.createRange().expand(Nt.isAnchor), o = t(N.head(e.nodes(Nt.isAnchor))),
        ...
        return e.prototype.initialize = function () {
            ...
            var e = this, o = t(), n = this.$dropzone.find(".note-dropzone-message");
            this.documentEventHandlers.onDragenter = function (t) {
                var i = e.context.invoke("codeview.isActivated"), r = e.$editor.width() > 0 && e.$editor.height() > 0;
    ...
    var Vt = function () {
        ...
        return e.prototype.initialize = function () {
            ...
            this.options.airMode || this.options.disableResizeEditor ? this.destroy() : this.$statusbar.on("mousedown", function (e) {
                ...
                var o = t.$editable.offset().top - t.$document.scrollTop(), n = function (e) {
        ...
        return e.prototype.initialize = function () {
            ...
            this.$handle = t(['<div class="note-handle">', '<div class="note-control-selection">', '<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>', '<div class="note-control-holder note-control-ne"></div>', '<div class="note-control-holder note-control-sw"></div>', '<div class="', this.options.disableResizeImage ? "note-control-holder" : "note-control-sizing", ' note-control-se"></div>', this.options.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>', "</div>", "</div>"].join("")).prependTo(this.$editingArea), this.$handle.on("mousedown", function (t) {
                if (Nt.isControlSizing(t.target)) {
                    ...
                    var o = e.$handle.find(".note-control-selection").data("target"), n = o.offset(),
                        i = e.$document.scrollTop(), r = function (t) {
            ...
            var o = Nt.isImg(e), n = this.$handle.find(".note-control-selection");
            if (this.context.invoke("imagePopover.update", e), o) {
                var i = t(e), r = i.position(), s = {
    ...
    }(), Zt = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i, Yt = function () {
        function e(t) {
            var e = this;
        ...
        return e.prototype.initialize = function () {
            ...
            if (this.lastWordRange) {
                var e = this.lastWordRange.toString(), o = e.match(Zt);
                if (o && (o[1] || o[2])) {
                    var n = o[1] ? e : "http://" + e, i = t("<a />").html(e).attr("href", n)[0];
        ...
        return e.prototype.representShortcut = function (t) {
            ...
            this.context.memo("button.bold", function () {
                ...
                return e.ui.buttonGroup({
                    ...
                    children: [e.button({
                        ...
                        click: function (o) {
                            var n = t(o.target), i = n.data("event"), r = n.data("value");
                            if (i && r) {
            ...
            this.context.memo("button.justifyLeft", C.invoke(s, "render")), this.context.memo("button.justifyCenter", C.invoke(a, "render")), this.context.memo("button.justifyRight", C.invoke(l, "render")), this.context.memo("button.justifyFull", C.invoke(c, "render")), this.context.memo("button.outdent", C.invoke(d, "render")), this.context.memo("button.indent", C.invoke(u, "render")), this.context.memo("button.paragraph", function () {
                return e.ui.buttonGroup([e.button({
                    ...
                    children: [s, a, l, c]
                }), e.ui.buttonGroup({className: "note-list", children: [d, u]})])]).render()
            ...
            var o = this, n = e || this.$toolbar, i = this.context.invoke("editor.currentStyle");
            ...
            var o, n = t(e.target.parentNode), i = n.next(), r = n.find(".note-dimension-picker-mousecatcher"),
                s = n.find(".note-dimension-picker-highlighted"), a = n.find(".note-dimension-picker-unhighlighted");
            if (void 0 === e.offsetX) {
                var l = t(e.target).offset();
                o = {x: e.pageX - l.left, y: e.pageY - l.top}
            } else o = {x: e.offsetX, y: e.offsetY};
            var c = Math.ceil(o.x / 18) || 1, d = Math.ceil(o.y / 18) || 1;
            s.css({
                width: c + "em",
                height: d + "em"
            }), r.data("value", c + "x" + d), c > 3 && c < this.options.insertTableMaxSize.col && a.css({width: c + 1 + "em"}), d > 3 && d < this.options.insertTableMaxSize.row && a.css({height: d + 1 + "em"}), i.html(c + " x " + d)
        }, e
    }(), te = function () {
        function e(e) {
        ...
        return e.prototype.shouldInitialize = function () {
            ...
            var e = this.$toolbar.parent(".note-toolbar-wrapper"), o = this.$editor.outerHeight(),
                n = this.$editor.width(), i = this.$toolbar.height();
            e.css({height: i});
            var r = 0;
        ...
        return e.prototype.initialize = function () {
            ...
            return t.Deferred(function (t) {
                var n = o.$dialog.find(".note-link-text"), i = o.$dialog.find(".note-link-url"),
                    r = o.$dialog.find(".note-link-btn"), s = o.$dialog.find("input[type=checkbox]");
        ...
        return e.prototype.shouldInitialize = function () {
            ...
            if (this.context.invoke("editor.hasFocus")) {
                ...
                if (e.isCollapsed() && e.isOnAnchor()) {
                    var o = Nt.ancestor(e.sc, Nt.isAnchor), n = t(o).attr("href");
        ...
        return e.prototype.initialize = function () {
            ...
            var e = this;
            return t.Deferred(function (t) {
                var o = e.$dialog.find(".note-image-input"), n = e.$dialog.find(".note-image-url"),
        ...
        return e.prototype.initialize = function () {
            ...
            var o,
                ...
                d = e.match(/\/\/v\.qq\.com\/x?\/?(page|cover).*?\/([^\/]+)\.html\??.*/), u = e.match(/^.+.(mp4|m4v)$/),
                h = e.match(/^.+.(ogg|ogv)$/), p = e.match(/^.+.(webm)$/);
            if (n && 11 === n[1].length) {
                var f = n[1];
            ...
            var o = this;
            return t.Deferred(function (t) {
                var n = o.$dialog.find(".note-video-url"), i = o.$dialog.find(".note-video-btn");
                o.ui.onDialogShown(o.$dialog, function () {
        ...
        return e.prototype.initialize = function () {
            ...
            var e = this, o = this.options.keyMap[z.isMac ? "mac" : "pc"];
            return Object.keys(o).map(function (n) {
                var i = o[n], r = t('<div><div class="help-list-item"/></div>');
        ...
        return e.prototype.shouldInitialize = function () {
            ...
            return o.map(function (o, i) {
                ...
                return r.append(n.template ? n.template(o) : o + ""), r.data({index: e, item: o}), r
            })
        }, e.prototype.handleKeydown = function (t) {
            ...
            var n = this, i = t('<div class="note-hint-group note-hint-group-' + e + '"/>');
            ...
            if (!N.contains([At.code.ENTER, At.code.UP, At.code.DOWN], t.keyCode)) {
                var o = this.context.invoke("editor.createRange").getWordRange(), n = o.toString();
        ...
        return e.prototype.initialize = function () {
            ...
            var e = this, o = t.extend({}, this.options.buttons);
            ...
            var t = N.head(arguments), e = N.tail(N.from(arguments)), o = t.split("."), n = o.length > 1,
    ...
    t.fn.extend({
        summernote: function () {
            var e = t.type(N.head(arguments)), o = "string" === e, n = "object" === e,
        ...
        version: "0.8.10", ui: y, dom: Nt, plugins: {}, options: {
            modules: {
                editor: jt,
                clipboard: qt,
                dropzone: Kt,
