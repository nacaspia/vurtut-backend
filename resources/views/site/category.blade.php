...
@section('site.content')
    ...
    <section class="our-listing pb30-991">
        <div class="container">
            @include('site.filter.mobile.category-company')
            <div class="row">
                @include('site.filter.category-company')
                <div class="col-xl-8">
                    <div class="row">
                    ...
                    <div class="row" id="companiesList">
                        @include('site.ajax.categories-company')
                    </div>
                    <div class="col-lg-12">
                        <div class="mbp_pagination mt10">
                            {!! $allCompaniesByCategory->links('site.pagination.category') !!}
                        </div>
