<div class="row">
    <div class="col-lg-12">
        <div class="breadcrumb_content style2 mb0-991">
            <h2 class="breadcrumb_title">{{ $mainCategory['title'][$currentLang] }}</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('site.index') }}">@lang('site.home')</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $mainCategory['title'][$currentLang] }}</li>
            </ol>
        </div>
    </div>
    <div class="col-lg-12">
                                    ...
                                    <li>
                                        <div class="search_option_two">
                                            <div class="sidebar_select_options">
                                                <select class="selectpicker w100 show-tick" id="city_id" name="city_id">
