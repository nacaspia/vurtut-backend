...
@section('admin.content')
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ route('admin.static-page.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="panel">
                                        ...
                                        <div class="tab-pane @if(++$key ==1) active @endif" id="{{$lang['code']}}"
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <textarea class="editor form-control" type="text" name="full_text[{{$lang['code']}}]" ></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <select class="form-control" name="type">
                                                ...
                                                <option value="about">@lang('admin.faqs')</option>
                                                <option value="about">@lang('admin.about')</option>
                                                <option value="terms-of-use">@lang('admin.terms-of-use')</option>
                                                <option value="privacy-policy">@lang('admin.privacy-policy')</option>
                                                <option value="how-we-work">@lang('how-we-work')</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
