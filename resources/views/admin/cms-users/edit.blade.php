                                            ...
                                            <div class="col-sm-6">
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" data-placeholder="Status"
                                                            name="status">
                                                        <option value="">-@lang('admin.choose')</option>
                                                        <option value="0" @if($cmsUser['status'] == 0) selected @endif>@lang('admin.nonactive')</option>
                                                        <option value="1" @if($cmsUser['status'] == 1) selected @endif>@lang('admin.active')</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
